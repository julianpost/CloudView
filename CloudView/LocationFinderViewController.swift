        ...
        placesClient?.currentPlace(callback: {
            ...
            if let placeLikelihoodList = placeLikelihoodList {
                ...
                if let place = place {
                    ...
                    CallForLocations.makeCategoryCall(dateFor.stringOfNormalYearStart, endDate: dateFor.stringOfNormalYearEnd, dataSet: "GHCND", dataType: "PRCP", zipCode: "05401") { responseObject in
